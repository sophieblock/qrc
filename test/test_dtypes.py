...
def test_cstruct_fields():
    ...
    structA = Struct(fields={"x": CInt(4), "y": CUInt(4)})
    structB = Struct(fields={"x": CInt(4), "y": CUInt(4)})

    structMismatch = Struct(fields={"x": CInt(4), "y": CUInt(5)})   # width diff
    structExtra    = Struct(fields={"x": CInt(4), "z": CBit()})      # key diff
    structQuantum  = Struct(fields={"x": CInt(4), "y": QBit()})      # cross-domain
...
def test_cstruct_fields2():
    ...
    """
    structA = Struct(fields={
        "x": CInt(4),
        "y": CUInt(4)
    })
    structB = Struct(fields={
        "x": CInt(4),
        "y": CUInt(4)
    })
    structMismatch = Struct(fields={
        "x": CInt(4),
        "y": CUInt(5)
    })
    structExtra = Struct(fields={
        "x": CInt(4),
        "z": CBit()
    })
