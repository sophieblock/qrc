...
def get_initial_learning_rate(grads, scale_factor=0.1, min_lr=1e-4, max_lr = 0.2):
    ...
    print(f"initial_lr: {initial_lr:.5f}")
...
def run_experiment(params, steps, n_rsv_qubits, n_ctrl_qubits, K_coeffs, trotter_steps,
    ...
    if opt_lr == None:
        ...
        clipped_lr, raw_lr = get_initial_learning_rate(init_grads)
        opt_lr = get_initial_lr_per_param(init_grads,max_lr=clipped_lr)
...
# --------------------------------------------------------------------------------------------
    ...
    # trainable_param_keys = ['test129', 'test175', 'test70', 'test12', 'test122', 'test47', 'test79', 'test197', 'test7']
    trainable_param_keys = ['test104', 'test129', 'test139', 'test175', 'test375', 'test124', 'test122', 'test18', 'test252', 'test79', 'test197', 'test325', 'test319', 'test7']
    ...
    if use_L:
        ...
        folder = f'./param_initialization_final/digital_results_res2/Nc_{N_ctrl}/epochs_{steps}'
