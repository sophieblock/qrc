...
from workflow.simulation.refactor.quantum_gates import SWAP,CX
from workflow.simulation.refactor.quantum import QuantumCircuit, QuantumInstruction
from workflow.simulation.refactor.devices.quantum_devices import QuantumDevice
from workflow.simulation.refactor.q_interop.transpilers import QiskitCompiler
...
# from workflow.simulation.refactor.q_interop.transpilers import QiskitCompiler
# from workflow.simulation.refactor.resources.quantum_resources import QuantumDevice
# from workflow.simulation.refactor.quantum import QuantumCircuit, QuantumInstruction
# from workflow.simulation.refactor.quantum_gates import CX, SWAP
...
#     assert depth == circ.depth(), f"Got depth = {depth}. Expected: {circ.depth()}"
